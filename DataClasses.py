...
# BDunbar, 2020-March-22, Added Track class code, modified CD class, added append, remove and sort Track functionalities
#------------------------------------------#
...
class Track():
    ...
    # -- Constructor -- #
    def __init__(self, trkPos: int, trkTtl: str, trkLgth: str):
        #  Attributes  #
        try:
            self.__position = int(trkPos)
            self.__title = str(trkTtl)
            self.__length = str(trkLgth)
    ...
    def position(self, value):
        try:
            ...
            raise Exception('Track Position needs to be a numeric number.')
...
class CD:
    ...
    def add_track(self, track: Track) -> None:
        ...
        """
        # TODOne - appended track
        self.__cd_tracks.append(track)
        # TODOne - sorted tracks
        self.__sort_tracks()
    ...
    def rmv_track(self, track_id: int) -> None:
        ...
        """
        # TODOne - added code to remove track
        del self.__cd_tracks[track_id - 1]

        # TODOne - added code to sort tracks
        self.__sort_tracks()
