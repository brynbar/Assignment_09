...
# BDunbar, 2020-March-22, modified method to accept a list of file names
# BDunbar, 2020-March-22, added code to save track data to file
#------------------------------------------#
...
class FileIO:
    ...
    def load_inventory(file_name: list) -> list:
        ...
        try:
            ...
            # TODOne added code to load track data
