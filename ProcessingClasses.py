...
# BDunbar, 2020-March-22, added code for selecting cd
# BDunbar, 2020-March-22, added code for adding track
#------------------------------------------#
...
class DataProcessor:
    ...
    def select_cd(table: list, cd_idx: int) -> DC.CD:
        ...
        for row in table:
            if row.cd_id == cd_idx:
                return row
        raise Exception('This CD does not exist in inventory.')
    ...
    def add_track(track_info: tuple, cd: DC.CD) -> None:
        ...
        try:
            ...
            raise Exception('The CD Position needs to be a numeric value.')
